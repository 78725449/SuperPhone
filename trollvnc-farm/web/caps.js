...
/** 配置表单定义（契约）：与设备端 _registerConfigSchemas 对齐，group=能力板块（2026-08-21 设计 7 章：
 *  连接/直连/画面/交互/保活/关于），group:null 项 UI 隐藏（FabAutoCollapse 固定行为无可调值，schema 保留）；
 *  BonjourEnabled/ViewOnlyPassword 已废弃 UI（底层键保留），从 CONFIG_DEFS 移除 */
export const CONFIG_DEFS = [
  { key: 'Scale', title: '输出缩放', type: 'number', min: 0.25, max: 1.0, step: 0.05, reload: 'restart', group: 'display' },
  { key: 'FrameRateSpec', title: '帧率', type: 'string', reload: 'hot', group: 'display' },
  { key: 'OrientationSync', title: '方向同步', type: 'bool', reload: 'hot', group: 'display' },
  { key: 'OrientationPadFix', title: '方向偏移', type: 'enum', enumValues: [0, 1, 2, 3], enumTitles: ['禁用', '90°', '180°', '270°'], reload: 'restart', group: 'display' },
  { key: 'DeferWindowSec', title: '延迟窗口', type: 'number', min: 0, max: 0.5, step: 0.005, reload: 'hot', group: 'display' },
  { key: 'MaxInflight', title: '最大并行帧', type: 'number', min: 0, max: 8, step: 1, reload: 'hot', group: 'display' },
  { key: 'PerformanceMode', title: '画质模式', type: 'enum', enumValues: ['performance', 'balanced', 'quality', 'custom'], enumTitles: ['流畅', '智能', '画质', '自定义'], reload: 'hot', group: 'display' },
  { key: 'TileSize', title: '分块大小', type: 'number', min: 8, max: 128, step: 1, reload: 'restart', group: 'display' },
  ...
  { key: 'AutoAssistEnabled', title: '辅助触控', type: 'bool', reload: 'instant', group: 'interaction' },
  { key: 'WheelStepPx', title: '滚轮步进', type: 'number', min: 0, max: 1000, step: 1, reload: 'hot', group: 'interaction' },
  { key: 'ViewOnly', title: '全局只读', type: 'bool', reload: 'instant', group: 'direct' },
  { key: 'FullPassword', title: '被控密码', type: 'password', reload: 'restart', group: 'direct' },
  { key: 'BindHost', title: '直连地址', type: 'string', reload: 'restart', group: 'direct' },
  { key: 'GatewayHost', title: '网关地址', type: 'string', reload: 'gateway', group: 'connection' },
  { key: 'GatewayToken', title: '网关令牌', type: 'password', reload: 'gateway', group: 'connection' },
  { key: 'KeepAliveSec', title: '防息屏间隔', type: 'number', min: 0, max: 300, step: 1, reload: 'hot', group: 'keepalive' },
  { key: 'Notifications', title: '通知模式', type: 'enum', enumValues: ['all', 'connectOnly', 'silent'], enumTitles: ['全部通知', '仅连接通知', '静默'], reload: 'instant', group: 'keepalive' },
  { key: 'KeyLogging', title: '键盘日志', type: 'bool', reload: 'instant', group: 'interaction' },
